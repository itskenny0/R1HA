...
val SETTINGS_REGISTRY: List<SettingEntry> = listOf(
    ...
    SettingEntry(
        ...
        category = SettingCategory.APPEARANCE,
        label = "Text size",
        description = "Font scale for every label and readout; larger steps suit wall-mounted kiosks",
    ...
    SettingEntry(
        ...
        category = SettingCategory.APPEARANCE,
        label = "Clock format",
        description = "12-hour (AM/PM) or 24-hour time readouts; auto follows the Android setting",
    ...
    SettingEntry(
        ...
        category = SettingCategory.APPEARANCE,
        label = "List density",
        description = "Comfortable or compact row spacing on list screens (devices, logbook, settings)",
    ...
    SettingEntry(
        ...
        category = SettingCategory.APPEARANCE,
        label = "Reduce motion",
        description = "Turn off animations: screen transitions cut instantly and the loading pulse freezes",
